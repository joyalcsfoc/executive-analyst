...
-- Known rels materialized by materialize_kg.sql: 'campaignRunsOnChannel', 'campaignTargetsSegment', 'dealerSellsModel', 'lineProducesModel', 'partStockedAt', 'plantHasLine', 'plantProducesModel', 'supplierSuppliesPart'
--
